	...
	<div class="col-10">
	  <div class="alert alert-success" role="alert">
		  <h4 class="alert-heading">¡Tú evaluación se ha guardado con éxito!</h4>
		 	<p>¡Muchas gracias por tu evaluación anónima sobre {{request()->get('empresa')}}!</p>

			<p>Estás a solo unos pasos de publicar tu evaluación:<br>
			Recibirás un enlace de nosotros para verificar tu correo electrónico a {{request()->get('email')}}.
